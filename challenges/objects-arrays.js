...
console.log(`${dinoLarge.weight}`);

// What was the diet of a velociraptor?
console.log(`${dinoMedium.weight}`);

// How long was a stegosaurus?
console.log(`${dinoSmall.length}`);

// What time period did tyrannosaurus live in?
console.log(`${dinoLarge.period}`);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
dinoLarge.roar = function() {
	return `RAWERSRARARWERSARARARRRR!`;
};

console.log(dinoLarge.roar());
...
let school = "";
for ( let i=0; i < graduates.length; i++ ){
  school = graduates[i].university;
	if (school.search("Uni") > -1){
...
*/
const populationTotal = zooAnimals.reduce((sum, localAnimals) => sum + localAnimals.population, 0);
